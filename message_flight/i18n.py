...
_TRANSLATIONS = {
    "zh": {
        ...
        "collection.unlock_via": "解锁方式：{name}",
        "settings.tab.collection": "收集",
        "voice.tab.title": "语音命令",
        "voice.enable": "启用语音命令",
        "voice.wake_word": "唤醒词",
        "voice.sensitivity": "灵敏度",
        "voice.sensitivity_hint": "越高越容易触发，但误触发也越多",
        "voice.custom_pinyin": "自定义唤醒词拼音",
        "voice.custom_pinyin_placeholder": "例如：n ǐ h ǎo x iǎo f ēi",
        "voice.custom_pinyin_hint": "留空使用预设唤醒词，填写后将覆盖预设（仅限中文唤醒词）",
        "voice.wake_word.hey_jarvis": "Hey Jarvis（英文）",
        "voice.wake_word.alexa": "Alexa（英文）",
        "voice.wake_word.hey_mycroft": "Hey Mycroft（英文）",
        "voice.wake_word.ni_hao_xiao_zhi": "你好小智（中文）",
        "voice.wake_word.ni_hao_xiao_fei": "你好小飞（中文）",
        "voice.wake_word.xiao_fei_xiao_fei": "小飞小飞（中文）",
        "voice.wake_word.xiao_ai_tong_xue": "小爱同学（中文）",
        "voice.listening": "我在听...",
        "voice.no_speech": "没有检测到语音",
        "voice.not_understood": "没听懂",
        "voice.network_error": "网络错误",
        "voice.mic_unavailable": "无法访问麦克风",
        "voice.init_failed": "语音命令初始化失败",
        "voice.disabled_hint": "启用后请保持应用在前台或最小化到托盘",
        "voice.cmd.pause": "已暂停",
        "voice.cmd.resume": "已恢复",
        "voice.cmd.next_preset": "已切换飞机",
        "voice.cmd.dnd_on": "免打扰已开启",
        "voice.cmd.dnd_off": "免打扰已关闭",
        "voice.cmd.open_settings": "已打开设置",
        "voice.cmd.quit_app": "正在退出",
        "voice.wake_word_hint": "建议使用 4 音节以上唤醒词以减少误触发",
        "voice.commands_title": "支持的语音命令",
        "voice.cmd_example.pause": "暂停 / 停止",
        "voice.cmd_example.resume": "恢复 / 继续",
        "voice.cmd_example.next_preset": "下一个 / 换飞机",
        "voice.cmd_example.toggle_dnd": "免打扰 / 勿扰",
        ...
        "mcp.confirm_title": "确认操作",
        "mcp.confirm_delete": "即将通过 {server} 执行 {tool}，此操作可能不可撤销，是否继续？",
        "mcp.cancelled": "操作已取消",
        "agent.chat_title": "智能助手",
        "agent.input_placeholder": "输入消息...",
    },
    "en": {
        ...
        "tray.chat": "AI Chat",
        "tray.preset_editor": "Plane editor",
        ...
        "collection.unlock_via": "Unlock via: {name}",
        "settings.tab.collection": "Collection",
        "voice.tab.title": "Voice Commands",
        "voice.enable": "Enable voice commands",
        "voice.wake_word": "Wake word",
        "voice.sensitivity": "Sensitivity",
        "voice.sensitivity_hint": "Higher = easier to trigger, but more false positives",
        "voice.custom_pinyin": "Custom wake word pinyin",
        "voice.custom_pinyin_placeholder": "e.g. n ǐ h ǎo x iǎo f ēi",
        "voice.custom_pinyin_hint": "Leave empty to use preset. Overrides preset for Chinese wake words only",
        "voice.wake_word.hey_jarvis": "Hey Jarvis",
        "voice.wake_word.alexa": "Alexa",
        "voice.wake_word.hey_mycroft": "Hey Mycroft",
        "voice.wake_word.ni_hao_xiao_zhi": "Ni Hao Xiao Zhi (Chinese)",
        "voice.wake_word.ni_hao_xiao_fei": "Ni Hao Xiao Fei (Chinese)",
        "voice.wake_word.xiao_fei_xiao_fei": "Xiao Fei Xiao Fei (Chinese)",
        "voice.wake_word.xiao_ai_tong_xue": "Xiao Ai Tong Xue (Chinese)",
        "voice.listening": "Listening...",
        "voice.no_speech": "No speech detected",
        "voice.not_understood": "Couldn't understand",
        "voice.network_error": "Network error",
        "voice.mic_unavailable": "Microphone unavailable",
        "voice.init_failed": "Voice commands init failed",
        "voice.disabled_hint": "Keep the app in foreground or minimized to tray when enabled",
        "voice.cmd.pause": "Paused",
        "voice.cmd.resume": "Resumed",
        "voice.cmd.next_preset": "Switched aircraft",
        "voice.cmd.dnd_on": "Do Not Disturb on",
        "voice.cmd.dnd_off": "Do Not Disturb off",
        "voice.cmd.open_settings": "Settings opened",
        "voice.cmd.quit_app": "Quitting",
        "voice.wake_word_hint": "Use 4+ syllable wake words to reduce false triggers",
        "voice.commands_title": "Supported voice commands",
        "voice.cmd_example.pause": "pause / stop",
        "voice.cmd_example.resume": "resume / continue",
        "voice.cmd_example.next_preset": "next / switch",
        "voice.cmd_example.toggle_dnd": "dnd / do not disturb",
        ...
        "mcp.confirm_title": "Confirm Action",
        "mcp.confirm_delete": "About to execute {tool} via {server}. This action may be irreversible. Continue?",
        "mcp.cancelled": "Action cancelled",
        "agent.chat_title": "AI Assistant",
        "agent.input_placeholder": "Type a message...",
    },
    "ja": {
        "tray.show": "飛行機を表示",
        "tray.pause": "飛行を一時停止",
